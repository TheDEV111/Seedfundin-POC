  ...
  return (
    <div className="flex-1 p-4 sm:p-8 bg-white/50">
      <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold text-[#2B2B26]">Landlord Dashboard</h1>
          <p className="text-xs sm:text-sm text-gray-500 mt-1">Overview of your properties and tenant applications.</p>
        </div>
